...
class Enemy {
    ...
    update() {
        ...
        // Debug: mostrar información del movimiento ocasionalmente
        ...
        // Si estamos muy cerca del punto objetivo, avanzar al siguiente
        if (distance < 5) {
            this.pathIndex++;
            console.log('Avanzando al siguiente punto. PathIndex:', this.pathIndex);
            if (this.pathIndex < this.path.length - 1) {
                // Moverse exactamente al punto alcanzado
                this.x = target.x;
                this.y = target.y;
            } else {
                // Llegamos al final
